...
async def test_fork_inherits_env():
    ...
    assert child.getenv('PARENT_VAR') == 'parent_value', "Child should inherit PARENT_VAR"
    ...
    assert child.getenv('PARENT_VAR') == 'parent_value', "Child should still have PARENT_VAR"
